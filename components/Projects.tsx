      ...
      <div className='w-[80%] pt-[2rem] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-[2rem]'>
        ...
        <div className='transform cursor-pointer hover:-translate-y-6 transition-all duration-20 relative w-[100%] h-[200px] md:h-[300px] sm:mb-[210px] max-sm:mb-[210px]'>
          ...
          <div className='flex flex-col items-center'>
            ...
            <p className='text-white text-[15px] text-center'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non impedit fugit voluptates culpa vero ullam odit? Corrupti sit impedit vero reprehenderit, natus deserunt mollitia architecto facilis, hic maiores nam rem!</p>
          </div>
