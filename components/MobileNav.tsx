...
const MobileNav = ({navigation,closeNavigation}:Props) => {
  ...
  return (
    <div className={`fixed ${navigaitonAnimation} transform transition-all duration-500 top-0 left-0 bottom-0 z-[1000] bg-[#09101a]`}>
        ...
        <div onClick={closeNavigation} className='absolute text-yellow-300 top-[2rem] right-[2rem] w-[2rem] h-[2rem ]'>
            <XMarkIcon/>
        </div>
    </div>
  )
